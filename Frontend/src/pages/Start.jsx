    ...
    <div>
      ...
      >
         <div className='flex flex-col p-3'>
          ...
          <div style={{ WebkitTextStroke: "3px black" }} className='bg-gradient-to-r from-rose-500 to-fuchsia-400 bg-clip-text text-transparent text-center text-6xl  font-bold mt-2 hover:text- duration-300'>RIDE WITH US RIDE WITH STYLE</div>
